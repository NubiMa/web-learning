                    ...
                    <div class="flex items-start justify-between mb-6">
                        <div class="flex items-center">
                            <div class="relative">
                                ...
                                <!-- Upload Button -->
                                <form id="uploadPictureForm" method="POST" action="{{ route('user.profile.update') }}"
                                ...
                                <button onclick="document.getElementById('profilePictureInput').click()"
                                    class="absolute bottom-0 right-0 w-8 h-8 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-50">
                        ...
                        <div class="flex space-x-3">
                            @if (Auth::user()->profile_picture)
                                <form method="POST" action="{{ route('user.profile.deletePicture') }}">
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                        class="px-4 py-2 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50">Delete</button>
                                </form>
                            @endif
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <form method="POST" action="{{ route('user.profile.update') }}">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="last_name"
                                    value="{{ count(explode(' ', Auth::user()->name)) > 1 ? explode(' ', Auth::user()->name)[1] : '' }}"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-6 mt-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="job_title" value="{{ Auth::user()->job_title }}"
                                    placeholder="Full Stack Student"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="bio" id="bioTextarea" rows="4" maxlength="240"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        ...
                        <div class="flex justify-end space-x-3 mt-6">
                            ...
                            <button type="submit"
                                class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Save Changes</button>
                        </div>
                    </form>
                </div>
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="flex justify-end space-x-3 mt-6">
                            <button type="button" onclick="this.form.reset()"
                                class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">Cancel</button>
                            <button type="submit"
                                class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Update
                                Password</button>
                        </div>
                    </form>
                </div>
